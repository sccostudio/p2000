...
export default async function Home() {
  ...
  const content = {
    ...fallback,
    ...data,
    menuPdfUrl: data?.menuPdfUrl || fallback.menuPdfUrl,
  }
  ...
  return (
    <div className="container">
      ...
      <main className="main">
        <div className="row">
          <div className="col">
            <h1 dangerouslySetInnerHTML={{ __html: content.mainHeading.replace('trattoria', '<br />&nbsp;trattoria') }} />
          </div>
          <div className="col-auto d-none d-md-block">
            <ul className="list-social">
              <li>
                <a href={`https://www.instagram.com/${content.instagramHandle.replace('@', '')}`} target="_blank">
        ...
        <footer className="footer">
          <div className="row">
            <div className="col-auto">
              ...
              <div className="d-block d-md-none">
                <a href={`https://www.instagram.com/${content.instagramHandle.replace('@', '')}`} className="social-mobile">
                  {content.instagramHandle}
                </a>
              </div>
            </div>
